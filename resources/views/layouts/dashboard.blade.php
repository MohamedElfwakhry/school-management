...
-->
<html @if(LaravelLocalization::getCurrentLocale()=='ar')
...
<!-- begin:: Header Mobile -->
@include('dashboard.includes.header-mobile')
<!-- end:: Header Mobile -->
            ...
            -->
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        @if(LaravelLocalization::getCurrentLocale() =='en')
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="{{asset('assets/america.png')}}" alt="" />
									</span>
                            </div>
                        @elseif(LaravelLocalization::getCurrentLocale() =='ar')
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="{{asset('assets/egypt.png')}}" alt="" />
									</span>
                            </div>
                        @endif
                                ...
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a class="kt-nav__link" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        @if($properties['native'] == "English")
                                            ...
                                            <span class="kt-nav__link-icon"><img class="" src="{{asset('assets/america.png')}}" alt="" /></span>
                                        @elseif($properties['native'] == "العربية")
                                            <i class="flag-icon flag-icon-sa"></i>
                                            <span class="kt-nav__link-icon"><img class="" src="{{asset('assets/egypt.png')}}" alt="" /></span>
                                        @endif
                                        {{ $properties['native'] }}
                                    </a>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-s">
                            ...
                            <div class="kt-notification">
                                ...
                                <div class="kt-notification__custom">
                                    <a href="{{route('admin.logout')}}" class="btn btn-label btn-label-brand btn-sm btn-bold">{{__('auth.signout')}}</a>
                                </div>
                            </div>
