                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle"> {{__('lang.createProduct')}}</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form class="kt-form" enctype="multipart/form-data" action="{{route('create.product')}}" method="POST" >
                                @csrf
                                <div class="kt-portlet__body">
                                    <div class="kt-section kt-section--first">
                                        ...
                                        <div class="form-group">
                                            <div class="dropdown">
                                                Select Sub_category:
                                                <select name="sub_category_id" class="select form-control" id="sub_category">
                        ...
                        <div class="kt-section__content">
                            <table class="table table-bordered table-hover" id=kt_tdata>
                                ...
                                <tr>
                                    ...
                                    <th title="Field #5">{{__('lang.category')}}</th>
                                    ...
                                    @foreach($products as $category)
                                        <tr class="data-row">
                                            ...
                                            @if(LaravelLocalization::getCurrentLocale()=='en')
                                                ...
                                                <td>{{$category->category->name_en}}</td>
                                                <td>{{$category->subCategories->name_en}}</td>
                                            @else
                                                <td>{{$category->category->name_ar}}</td>
                                                <td>{{$category->subCategories->name_ar}}</td>
                                            @endif
                                            <td>
...
@section('js')
    ...
    <script>
        $("#main_category").on('keyup , click , change',function(){
            var id=$(this).val()
/*
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
*/
